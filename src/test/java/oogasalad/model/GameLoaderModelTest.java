...
public class GameLoaderModelTest {
  ...
  public void setup() {
    ...
    Collidable c1 = new Collidable(1, Double.POSITIVE_INFINITY, 0,0, true, 3.03873, 2.03873, 0.0, 500, 500, "rectangle");
    Collidable c2 = new Collidable(2, 1, 250, 450, true, 0, 0, 2, 2, 0.0,  "circle");
    Collidable c3 = new Collidable(3, 0, 250,50, true, 0,0, 5, 5, 0.0, "circle");
    Collidable c4 = new Collidable(4, 200, 0, 0, true, 0,0, 500, 10, 0.0, "rectangle");
    Collidable c5 = new Collidable(5, 200, 0, 0, true, 0,0, 10, 500, 0.0, "rectangle");
    Collidable c6 = new Collidable(6, 200, 490, 0, true, 0,0, 10, 500, 0.0, "rectangle");
    Collidable c7 = new Collidable(7, 200, 0, 490, true, 0,0, 500, 10, 0.0,"rectangle");
