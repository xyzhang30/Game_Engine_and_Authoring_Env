...
public class GameBuilderTest {
  ...
  public void setup() {
    ...
    GameObjectProperties co1 = new GameObjectProperties(1, List.of("visible", "surface"), 100.0,
        new Position(0, 0), "rectangle", new Dimension(500, 500), Map.of("Default",List.of(100,
        200, 100)), 3.03873
        , 2.03873, 0,Map.of("Default","sample.img"),0, false, false, 0.0);
    GameObjectProperties co2 = new GameObjectProperties(2, List.of("visible", "collidable"), 1.0,
        new Position(250, 450), "circle", new Dimension(2, 2), Map.of("Default",List.of(100,
        200, 100)), 0.0, 0.0,0
        ,Map.of("Default","sample.img"),0, false, false, 0.0);
    GameObjectProperties co3 = new GameObjectProperties(3, List.of("visible", "surface"), 0.0,
        new Position(250, 50), "circle", new Dimension(5, 5), Map.of("Default",List.of(100,
        200, 100)), 0.0, 0.0, 0,
        Map.of("Default","sample.img"),0, false, false, 0.0);
