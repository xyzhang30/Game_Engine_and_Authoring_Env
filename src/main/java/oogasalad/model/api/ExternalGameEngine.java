...
/**
 * The ExternalGameEngine interface defines methods for the GameController to interact
 * with the game engine. It provides functionality for updating the game state, applying initial
 * velocities to game objects, and resetting the game to its initial state.
 *
 * @author Noah Loewy
 */
public interface ExternalGameEngine {
  ...
  /**
   * Represents a timestep update for a game. Within this timestep, all physics helper functions
   * are called to represent movement, collision detection, and event handling in the backend.
   * The front end then received an immutable record.
   *
