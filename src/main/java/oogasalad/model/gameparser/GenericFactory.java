...
public class GenericFactory {
  ...
  private static final Logger LOGGER = LogManager.getLogger(GenericFactory.class);
  ...
  public static PlayerRecordComparator createRankComparator(String compName)
      throws InvalidCommandException {
    return GenericFactory.createInstance(RANK_COMPARATOR_PATH, compName, PlayerRecordComparator.class);
  }
  public static TurnPolicy createTurnPolicy(String compName, PlayerContainer container)
      throws InvalidCommandException {
    return GenericFactory.createInstance(TURN_POLICY_PATH, compName, TurnPolicy.class, container);
  }
  public static StrikePolicy createStrikePolicy(String compName)
      throws InvalidCommandException {
    return GenericFactory.createInstance(STRIKE_POLICY_PATH, compName, StrikePolicy.class);
  }
