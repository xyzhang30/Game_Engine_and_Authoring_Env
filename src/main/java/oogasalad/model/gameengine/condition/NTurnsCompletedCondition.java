...
public class NTurnsCompletedCondition implements Condition {
  ...
  /**
   * Evaluates whether the specified number of turns have been completed in the game by each
   * player. The work is delegated to PlayerContainer's allPlayersCompletedNTurns method.
   *
