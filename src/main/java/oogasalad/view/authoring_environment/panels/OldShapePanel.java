...
public class ShapePanel implements Panel {
  ...
  private void createSizeAndAngleSliders() {
    ...
    xSlider = createSizeSlider(resourceBundle.getString("XScaleLabel"), sliderContainerBox);

    // removing hardcoding - 2 or more times, appears in UI, involved in logic

    xSlider.setId("XSizeSlider");
    ySlider = createSizeSlider(resourceBundle.getString("YScaleLabel"), sliderContainerBox);
    ySlider.setId("YSizeSlider");
    angleSlider = createAngleSlider(resourceBundle.getString("AngleLabel"), sliderContainerBox);
  ...
  private Slider createAngleSlider(String labelText, VBox sliderContainerBox) {
